...
static const char *const yytname[] =
{
  ...
  "connection", "sess_attributes", "attributes", "attribute", "attribute2",
  "@7", "@8", "media_list", "media", "@9", "@10", "transport", "formats",
...
#line 125 "sdp_parser.yxx"
  ...
  case 6:
#line 126 "sdp_parser.yxx"
    {
			SDP->version = (yyvsp[(3) - (5)].yysdpt_int); }
    break;
...
#line 130 "sdp_parser.yxx"
  ...
  case 9:
#line 131 "sdp_parser.yxx"
    {
			SDP->origin.username = *(yyvsp[(3) - (10)].yysdpt_str);
			SDP->origin.session_id = *(yyvsp[(5) - (10)].yysdpt_str);
			SDP->origin.session_version = *(yyvsp[(6) - (10)].yysdpt_str);
			SDP->origin.network_type = (yyvsp[(7) - (10)].yysdpt_ntwk_type);
			SDP->origin.address_type = (yyvsp[(8) - (10)].yysdpt_addr_type);
			SDP->origin.address = *(yyvsp[(9) - (10)].yysdpt_str);
			MEMMAN_DELETE((yyvsp[(3) - (10)].yysdpt_str)); delete (yyvsp[(3) - (10)].yysdpt_str);
			MEMMAN_DELETE((yyvsp[(5) - (10)].yysdpt_str)); delete (yyvsp[(5) - (10)].yysdpt_str);
			MEMMAN_DELETE((yyvsp[(6) - (10)].yysdpt_str)); delete (yyvsp[(6) - (10)].yysdpt_str);
			MEMMAN_DELETE((yyvsp[(9) - (10)].yysdpt_str)); delete (yyvsp[(9) - (10)].yysdpt_str); }
    break;

  case 10:
#line 144 "sdp_parser.yxx"
    { try {
				(yyval.yysdpt_ntwk_type) = str2sdp_ntwk_type(*(yyvsp[(1) - (1)].yysdpt_str));
  ...
  case 11:
#line 159 "sdp_parser.yxx"
    { try {
				(yyval.yysdpt_addr_type) = str2sdp_addr_type(*(yyvsp[(1) - (1)].yysdpt_str));
				MEMMAN_DELETE((yyvsp[(1) - (1)].yysdpt_str)); delete (yyvsp[(1) - (1)].yysdpt_str);
			    }
			    catch (t_sdp_syntax_error) {
...
#line 171 "sdp_parser.yxx"
    {
			SDP->session_name = *(yyvsp[(3) - (5)].yysdpt_str);
			MEMMAN_DELETE((yyvsp[(3) - (5)].yysdpt_str)); delete (yyvsp[(3) - (5)].yysdpt_str); }
    break;

  case 15:
#line 176 "sdp_parser.yxx"
    {
			SDP->connection = *(yyvsp[(1) - (1)].yysdpt_connection);
			MEMMAN_DELETE((yyvsp[(1) - (1)].yysdpt_connection)); delete (yyvsp[(1) - (1)].yysdpt_connection); }
    break;

  case 16:
#line 181 "sdp_parser.yxx"
    { (yyval.yysdpt_connection) = new t_sdp_connection(); MEMMAN_NEW((yyval.yysdpt_connection)); }
    break;

  case 17:
#line 183 "sdp_parser.yxx"
    {
			(yyval.yysdpt_connection) = new t_sdp_connection();
			MEMMAN_NEW((yyval.yysdpt_connection));
			(yyval.yysdpt_connection)->network_type = (yyvsp[(2) - (5)].yysdpt_ntwk_type);
			(yyval.yysdpt_connection)->address_type = (yyvsp[(3) - (5)].yysdpt_addr_type);
			(yyval.yysdpt_connection)->address = *(yyvsp[(4) - (5)].yysdpt_str);
			MEMMAN_DELETE((yyvsp[(4) - (5)].yysdpt_str)); delete (yyvsp[(4) - (5)].yysdpt_str); }
    break;

  case 18:
#line 192 "sdp_parser.yxx"
    {
			SDP->attributes = *(yyvsp[(1) - (1)].yysdpt_attributes);
			MEMMAN_DELETE((yyvsp[(1) - (1)].yysdpt_attributes)); delete (yyvsp[(1) - (1)].yysdpt_attributes); }
    break;
...
#line 197 "sdp_parser.yxx"
  ...
  case 20:
#line 198 "sdp_parser.yxx"
    {
			(yyval.yysdpt_attributes)->push_back(*(yyvsp[(2) - (2)].yysdpt_attribute));
			MEMMAN_DELETE((yyvsp[(2) - (2)].yysdpt_attribute)); delete (yyvsp[(2) - (2)].yysdpt_attribute); }
    break;

  case 21:
#line 203 "sdp_parser.yxx"
    {
			(yyval.yysdpt_attribute) = (yyvsp[(2) - (3)].yysdpt_attribute); }
    break;

  case 22:
#line 207 "sdp_parser.yxx"
    {
			(yyval.yysdpt_attribute) = new t_sdp_attr(*(yyvsp[(1) - (1)].yysdpt_str));
...
#line 211 "sdp_parser.yxx"
    {
			(yyval.yysdpt_attribute) = new t_sdp_attr(*(yyvsp[(1) - (5)].yysdpt_str), *(yyvsp[(4) - (5)].yysdpt_str));
			MEMMAN_NEW((yyval.yysdpt_attribute));
			MEMMAN_DELETE((yyvsp[(1) - (5)].yysdpt_str)); delete (yyvsp[(1) - (5)].yysdpt_str);
			MEMMAN_DELETE((yyvsp[(4) - (5)].yysdpt_str)); delete (yyvsp[(4) - (5)].yysdpt_str); }
    break;
...
#line 219 "sdp_parser.yxx"
    {
			SDP->media.push_back(*(yyvsp[(2) - (2)].yysdpt_media));
			MEMMAN_DELETE((yyvsp[(2) - (2)].yysdpt_media)); delete (yyvsp[(2) - (2)].yysdpt_media); }
    break;

  case 28:
#line 225 "sdp_parser.yxx"
    { CTX_NUM; }
    break;
